...
<form onSubmit={onSubmitHandler} className='space-y-3 mt6 text-sm' >
...
<div className='grid grid-cols-2 gap-4'>
 ...
 < InputField  handleChange={handleChange} address={address} name="phone" type="phone" placeholder="Phone"   />
